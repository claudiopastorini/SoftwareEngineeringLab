 ...
 * @author biar
 */
public class ArtistImpressionConsumer {
    ...
    public ArtistImpressionConsumer(String servantIpAddress, int servantPortNumber, String topic) {
        // TODO: validate IP
        ...
        properties.setProperty(Context.PROVIDER_URL, "tcp://pfp-VirtualBox:61616");
        ...
        try {
            ...
            Logger.getLogger(ArtistImpressionConsumer.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        Logger.getLogger(ArtistImpressionConsumer.class.getName()).log(Level.INFO, "Client initialized!");
    }
    
    public void start(String selector, MessageListener messageListener) throws JMSException {
        Logger.getLogger(ArtistImpressionConsumer.class.getName()).log(Level.INFO, "Starting client...");
    ...
    public void stop() throws JMSException {
        Logger.getLogger(ArtistImpressionConsumer.class.getName()).log(Level.INFO, "Stopping client...");
        
        this.consumer.close();
        
        Logger.getLogger(ArtistImpressionConsumer.class.getName()).log(Level.INFO, "Client stopped!");
    }
    ...
    public static String generateArtistsTopic(String artistName) {
        ...
        return String.format("dynamicTopics/%s", artistName);
    }
